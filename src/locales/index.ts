...
export const i18n: Record<TLang, any> = {
  ...
  tj: {
    ...
    prompt: {
      system: (tone: string) =>
        `Ту таҳриргари касбӣ ва копирайтер ҳастӣ. Матни додашударо дар ${tone} қайд кун.\nҲатман:\n- Матнро табиӣ ва осонхонда соз.\n- Қисмҳои сабуки эҳсосот ва ифодавиро илова кун, ки ба услуб мувофиқанд.\n- Агар матн кӯтоҳ аст (1–2 ҷумла), онро каме зиндатар кун, вале аз ҳад зиёд ороиш макун.`,
      user: "Матн барои қайд кардан:",
    },
  },
